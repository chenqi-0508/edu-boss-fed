      ...
      <el-form ref="form" :model="course" label-width="80px">
        ...
        <div v-show="activeStep === 1">
          <el-form-item label="课程封面">
            <course-img v-model="course.courseListImg" :limit="5"/>
          </el-form-item>
          <el-form-item label="介绍封面">
            <course-img v-model="course.courseImgUrl" :limit="5"/>
          </el-form-item>
        </div>
        <!-- 销售信息 -->
        ...
        <div v-show="activeStep === 3">
          ...
          <template v-if="course.activityCourse">
            ...
            <el-form-item label="秒杀价">
              <el-input-number v-model="course.activityCourseDTO.amount">
                <template slot="append">元</template>
              </el-input-number>
            </el-form-item>
            <el-form-item label="秒杀库存">
              <el-input-number v-model="course.activityCourseDTO.stock">
        ...
        <div v-show="activeStep === 4">
          ...
          <el-form-item>
            <el-button type="primary" @click="handleSaveCourse">完成</el-button>
          </el-form-item>
        </div>
